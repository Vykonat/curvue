...
export default class NavDrawer extends Vue {
    ...
    /**
     * Nav drawer computed properties
     */
    get navDrawerCssClasses() {
        // Returns an array of classses to use based on the components props
    ...
    get hamburgerClasses() {
        /**
         * Returns an aray of classses to use on the hamburger button
         */
    ...
    get isMobileScreenSize() {
        // Checks if the users screen is less than 728px
