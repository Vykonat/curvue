...
export default class cwdNavigationProgress extends Vue {
    /**
     * Navigation Progress props
     */
    @Prop({ required: true }) isNavigating!: boolean; // Checks if the user is currently navigating


    /**
     * Navigation Progress provided data
     */
    ...
    /**
     * Navigation Progress computed properties
     */
