...
export default class cwdButton extends Vue {
    ...
    @Prop() target: string | undefined                                            // The route a button points to
    @Prop() isOutlined: boolean | undefined;                                      // Whether or not to use outlines
    @Prop() isGhost: boolean | undefined;                                         // Whether or not to use ghost button
