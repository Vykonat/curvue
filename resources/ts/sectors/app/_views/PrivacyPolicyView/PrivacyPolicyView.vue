<template lang="pug">
  lvql-layout( name="Default" )
    grid-row
      grid-item( fill )
        h2 {{ appStrings.APP_NAME }} privacy policy
        panel
          panel-body
            p 
              | Your privacy is important to us. It is {{ appStrings.APP_NAME }}'s policy to respect your privacy regarding any information we may 
              | collect from you across our website, {{ appStrings.APP_URL }}, and other sites we own and operate.
            p 
...
import { APP_NAME, APP_URL } from '../../../../common/config/app.config';
